...
! 20*3
INTEGER,PARAMETER:: IBAR=60, JBAR=60, KBAR=20, NT=3
...
! time loop   
  do t=1,nt  
   ...
   do i=1,ibp1
      do k=1,kbp1       
          US(i,k,t)=u_in(i,1,k,t)
          VS(i,k,t)=v_in(i,1,k,t)
          WS(i,k,t)=w_in(i,1,k,t)
      enddo
   enddo
   do i=1,ibar
      do k=1,kbar
          TS(i,k,t)=t_in(i,1,k,t)
      enddo
   enddo
   ...
   do i=1,ibp1
      do k=1,kbp1       
          UN(i,k,t)=u_in(i,jbp1,k,t)
          VN(i,k,t)=v_in(i,jbp1,k,t)
          WN(i,k,t)=w_in(i,jbp1,k,t)
      enddo
   enddo
   do i=1,ibar
      do k=1,kbar
          TN(i,k,t)=t_in(i,jbar,k,t)
      enddo
   enddo
   ...
   do j=1,jbp1
      do k=1,kbp1       
          UE(j,k,t)=u_in(1,j,k,t)
          VE(j,k,t)=v_in(1,j,k,t)
          WE(j,k,t)=w_in(1,j,k,t)
      enddo
   enddo
   do j=1,jbar
      do k=1,kbar
          TE(j,k,t)=t_in(1,j,k,t)
      enddo
   enddo
   ...
   do j=1,jbp1
      do k=1,kbp1       
          UW(j,k,t)=u_in(ibp1,j,k,t)
          VW(j,k,t)=v_in(ibp1,j,k,t)
          WW(j,k,t)=w_in(ibp1,j,k,t)
      enddo
   enddo
   do j=1,jbar
      do k=1,kbar
          TW(j,k,t)=t_in(ibar,j,k,t)
      enddo
   enddo
 enddo !timeloop

PRINT*, UE(2,2,2),UW(2,2,2), u_in(2,1,2,2),u_in(2,jbar,2,2)
PRINT*, TN(2,2,2),TS(2,2,2), t_in(2,1,2,2),t_in(2,jbar,2,2)
