!take data from 8_2 and make BC for 8_3 (face-centered!!)
! time-evolving V0, W0, W1
! based on coupled_glue_meshes_3_2
! add more sides
...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
!Run name - folder that is used to make BC

 CALL GET_COMMAND_ARGUMENT(1, run_name)

end_file_name= 'BC_from_' // TRIM(run_name)//  '.nc'
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 PRINT*, 'started'
