...
! READ PALM sections 
  ...
  status=nf90_get_var(ncid_in, varid_u, u_in,start=(/157,157,2,3600/), &
                                           count = (/ IBAR, JBAR, KBAR ,1 /))
  status=nf90_get_var(ncid_in, varid_v, v_in,start=(/157,157,2,3600/), &
                                           count = (/ IBAR, JBAR, KBAR ,1 /))
  status=nf90_get_var(ncid_in, varid_w, w_in,start=(/157,157,2,3600/), &
                                           count = (/ IBAR, JBAR, KBAR ,1 /)) 
