...
!write file with variables for the internal grid only 
 ...
 status = nf90_put_var(ncid_out, varid_uout, u_all(1:61,1:61,1:61, 1))
 status = nf90_put_var(ncid_out, varid_vout, v_all(1:61,1:61,1:61, 1))
 status = nf90_put_var(ncid_out, varid_wout, w_all(1:61,1:61,1:61, 1))
