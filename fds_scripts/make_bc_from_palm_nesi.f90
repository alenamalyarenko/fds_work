...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 print*, 'made out variables E'         
  ...
  ENDDO                        
      ...
      print*, 'made out variables roof ', T             
            
 ENDDO !end timeloop  
 
  print*, 'made out variables'
