...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 ! add +1 to t_all indeces as t_all is 1:(ibp1+1)
  ...
  DO J=1,JBARout
   DO K=1,KBARout
    TE(i,k,t)=t_fc_EW(0,j,k,t)-273.15
    UE(i,k,t)=u_fc_EW(0,j,k,t)    
    VE(i,k,t)=v_fc_EW(0,j,k,t)    
    WE(i,k,t)=w_fc_EW(0,j,k,t)       
   ENDDO
  ENDDO               
                      
   DO J=1,JBARout
   DO K=1,KBARout
    TW(i,k,t)=t_fc_EW(IBARout,j,k,t)-273.15
    UW(i,k,t)=u_fc_EW(IBARout,j,k,t)    
    VW(i,k,t)=v_fc_EW(IBARout,j,k,t)    
    WW(i,k,t)=w_fc_EW(IBARout,j,k,t)       
   ENDDO
  ENDDO                        
