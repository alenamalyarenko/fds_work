...
!%%%%%% change for each run:
! Standalone:
INTEGER,PARAMETER:: IBAR=60, JBAR=60, KBAR=60, NT=1000
...
REAL, ALLOCATABLE, DIMENSION(:,:,:):: TS_5,US_5,VS_5,WS_5
REAL, ALLOCATABLE, DIMENSION(:,:,:):: TN_5,UN_5,VN_5,WN_5
REAL, ALLOCATABLE, DIMENSION(:,:,:):: TE_5,UE_5,VE_5,WE_5     
REAL, ALLOCATABLE, DIMENSION(:,:,:):: TW_5,UW_5,VW_5,WW_5  
...
!size varibales
 ...
 !
 ALLOCATE( TS_5(1:(IBARout),1:(KBARout),NTout))
 ALLOCATE( US_5(1:(IBARout),1:(KBARout),NTout))  
 ALLOCATE( VS_5(1:(IBARout),1:(KBARout),NTout))
 ALLOCATE( WS_5(1:(IBARout),1:(KBARout),NTout))
 ALLOCATE( TN_5(1:(IBARout),1:(KBARout),NTout))
 ALLOCATE( UN_5(1:(IBARout),1:(KBARout),NTout))  
 ALLOCATE( VN_5(1:(IBARout),1:(KBARout),NTout))
 ALLOCATE( WN_5(1:(IBARout),1:(KBARout),NTout))                                               
 ALLOCATE( TE_5(1:(JBARout),1:(KBARout),NTout))    
 ALLOCATE( UE_5(1:(JBARout),1:(KBARout),NTout))    
 ALLOCATE( VE_5(1:(JBARout),1:(KBARout),NTout))    
 ALLOCATE( WE_5(1:(JBARout),1:(KBARout),NTout))                                                   
 ALLOCATE( TW_5(1:(JBARout),1:(KBARout),NTout))    
 ALLOCATE( UW_5(1:(JBARout),1:(KBARout),NTout))    
 ALLOCATE( VW_5(1:(JBARout),1:(KBARout),NTout))    
 ALLOCATE( WW_5(1:(JBARout),1:(KBARout),NTout))  
 !
 ...
 COUNT5=0
  DO T=1,NT,5
   ...
   DO K=1,KBARout  
    ...
    TS_5(I,K,COUNT5)=TS(i,k,t)
    US_5(I,K,COUNT5)=US(i,k,t)
    VS_5(I,K,COUNT5)=VS(i,k,t)
    WS_5(I,K,COUNT5)=WS(i,k,t)
    
    TN_5(I,K,COUNT5)=TN(i,k,t)   
    UN_5(I,K,COUNT5)=UN(i,k,t)   
    VN_5(I,K,COUNT5)=VN(i,k,t)   
    WN_5(I,K,COUNT5)=WN(i,k,t)   
end do
enddo
  ...
  DO J=1,JBARout     
   DO K=1,KBARout    
    ...
    TE_5(J,K,COUNT5)=TE(j,k,t)   
    UE_5(J,K,COUNT5)=UE(j,k,t)   
    VE_5(J,K,COUNT5)=VE(j,k,t)   
    WE_5(J,K,COUNT5)=WE(j,k,t)   


    TW_5(J,K,COUNT5)=TW(j,k,t)   
    UW_5(J,K,COUNT5)=UW(j,k,t)   
    VW_5(J,K,COUNT5)=VW(j,k,t)   
    WW_5(J,K,COUNT5)=WW(j,k,t)   
    enddo
    enddo
  ENDDO
...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 !output - 5s
 status= nf90_create(path=end_file_name1, cmode=or(nf90_noclobber,nf90_64bit_offset), ncid=ncid_out)
 
 status = nf90_def_dim(ncid_out, "xc",  ibarout, dimxc)  
 status = nf90_def_dim(ncid_out, "yc", jbarout, dimyc)  
 status = nf90_def_dim(ncid_out, "zc",  kbarout, dimzc)
 status = nf90_def_dim(ncid_out, "time",COUNT5, dimt)   
 ...
 status = nf90_put_var(ncid_out, varid_tsout, TS_5(1:IBARout,1:KBARout, 1:COUNT5))
 status = nf90_put_var(ncid_out, varid_usout, US_5(1:IBARout,1:KBARout, 1:COUNT5))
 status = nf90_put_var(ncid_out, varid_vsout, VS_5(1:IBARout,1:KBARout, 1:COUNT5))
 status = nf90_put_var(ncid_out, varid_wsout, WS_5(1:IBARout,1:KBARout, 1:COUNT5))
 status = nf90_put_var(ncid_out, varid_tnout, TN_5(1:IBARout,1:KBARout, 1:COUNT5))
 status = nf90_put_var(ncid_out, varid_unout, UN_5(1:IBARout,1:KBARout, 1:COUNT5))
 status = nf90_put_var(ncid_out, varid_vnout, VN_5(1:IBARout,1:KBARout, 1:COUNT5))
 status = nf90_put_var(ncid_out, varid_wnout, WN_5(1:IBARout,1:KBARout, 1:COUNT5)) 
 status = nf90_put_var(ncid_out, varid_teout, TE_5(1:JBARout,1:KBARout, 1:COUNT5))
 status = nf90_put_var(ncid_out, varid_ueout, UE_5(1:JBARout,1:KBARout, 1:COUNT5))
 status = nf90_put_var(ncid_out, varid_veout, VE_5(1:JBARout,1:KBARout, 1:COUNT5))
 status = nf90_put_var(ncid_out, varid_weout, WE_5(1:JBARout,1:KBARout, 1:COUNT5)) 
 status = nf90_put_var(ncid_out, varid_twout, TW_5(1:JBARout,1:KBARout, 1:COUNT5))
 status = nf90_put_var(ncid_out, varid_uwout, UW_5(1:JBARout,1:KBARout, 1:COUNT5))
 status = nf90_put_var(ncid_out, varid_vwout, VW_5(1:JBARout,1:KBARout, 1:COUNT5))
 status = nf90_put_var(ncid_out, varid_wwout, WW_5(1:JBARout,1:KBARout, 1:COUNT5))
 ...
 status = nf90_def_dim(ncid_out, "yc", jbarout, dimyc)  
 status = nf90_def_dim(ncid_out, "zc",  kbarout, dimzc)
 status = nf90_def_dim(ncid_out, "time",COUNT10, dimt)   
