...
!OUTPUT FDS FILES
       status= nf90_create('ic_pal3.nc', NF90_CLOBBER, ncid_out)

       status = nf90_def_dim(ncid_out, "xc", ibp1, dimxc)  
       status = nf90_def_dim(ncid_out, "yc", jbp1, dimyc)  
       status = nf90_def_dim(ncid_out, "zc", kbp1, dimzc)  
