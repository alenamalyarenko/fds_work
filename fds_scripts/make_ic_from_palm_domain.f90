...
CALL GET_COMMAND_ARGUMENT(2, IBAR1)
CALL GET_COMMAND_ARGUMENT(3, JBAR1)
CALL GET_COMMAND_ARGUMENT(4, KBAR1)
CALL GET_COMMAND_ARGUMENT(5, I_UPPER1)
CALL GET_COMMAND_ARGUMENT(6, J_UPPER1)
...
Print*, run_name, IBAR, JBAR, KBAR, I_UPPER, J_UPPER
