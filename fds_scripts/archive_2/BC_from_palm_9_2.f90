...
! 20*3
INTEGER,PARAMETER:: IBAR=60, JBAR=60, KBAR=20, NT=3000
INTEGER, PARAMETER:: IBP1=61, JBP1=61, KBP1=21
INTEGER, PARAMETER:: IBP2=62, JBP2=62, KBP2=22

!read from palm
REAL, DIMENSION(IBP2,JBP2,KBP2,NT):: t_in,u_in,v_in,w_in
integer:: x1,y1,z1,t1
...
! READ PALM 
    status=nf90_open('palm_output_high_freq.nc', nf90_nowrite, ncid_in)
  ...
  status=nf90_get_var(ncid_in, varid_u, u_in,start=(/x1,y1,z1,t1/), count = (/ IBAR+2, JBAR+2, KBAR+2 ,nt /))
  
  ! 156:217, 157:218 (62,62)
  status=nf90_get_var(ncid_in, varid_v, v_in,start=(/x1,y1,z1,t1/), count = (/ IBAR+2, JBAR+2, KBAR+2 ,nt /))
  
  ! 156:217, 156:217 (62,62)
  status=nf90_get_var(ncid_in, varid_w, w_in,start=(/x1,y1,z1,t1/), count = (/ IBAR+2, JBAR+2, KBAR+2 ,nt /)) 
  
  ! 156:217, 156:217 (62,62)
  status=nf90_get_var(ncid_in, varid_t, t_in,start=(/x1,y1,z1,t1/), count = (/ IBAR+2, JBAR+2, KBAR+2 ,nt /))
  ...
  do t=1,nt  
   ...
   do j=1,jbp2
      do k=1,kbp2       
          ...
          WE1(j,k,t)=w_in(ibp1,j,k,t)
          WE2(j,k,t)=w_in(ibp2,j,k,t)             
      enddo
   enddo
   ...
   do j=1,jbp2
      do k=1,kbp2       
          ...
          WW1(j,k,t)=w_in(1,j,k,t)
          WW2(j,k,t)=w_in(2,j,k,t)
      enddo
   enddo
