...
INTEGER:: IBP1, JBP1, KBP1, IBP2, JBP2,KBP2
...
!write file with full varriables - out of time loop
 ...
 do t=1,count
  ...
  DO I=1,IBARout+2
   DO K=1,KBARout+2
    VS0(i,k,t)=v_all(i,1,k,t)    !v(0:ibp1,0,0:ibp1) in model numbering
    WS0(i,k,t)=w_all(i,1,k,t)    !v(0:ibp1,0,0:ibp1) in model numbering
    WS1(i,k,t)=w_all(i,2,k,t)    !v(0:ibp1,0,0:ibp1) in model numbering    
   ENDDO
  ENDDO 
