...
% x_m=128; y_m=128;z_m=1024;
 ...
 name='Palm2_3'; meshes=40;
 %gris cells per mesh: IJK
 xmesh=25; ymesh=25; zmesh=200;
 I_upper=20;J_upper=2;
 %size of mesh  in meters: DX DY DZ 
 x_m=500; y_m=500;z_m=1000;
...
path='/nesi/project/vuw03158/fds/long2';
